...
print("-----------------------------------------")
# Get user input
h = input("Please input the relevant hight: " )
arm_and_takeoff(h)

print("Set default/target airspeed to  You  favorite Hight ")
s = input("Please input the relevant Speed : " )
vehicle.airspeed = s
lat = input("Please give 1 value  and  Latitude:-35.3609336, 149.1648209\n ")
lon = input("Please give 1 value the Longitude:-35.3609336, 149.1648209\n ")
alt = input("Please give 1 value the Altitude : \n")
print("-----------------------------------------")
...
print("Do you want to continue flying :y/n")
ans = str(input("Please input y for YES  n  for No: " ))
if ans == 'y':
    h = input("Please input the relevant hight: " )
    arm_and_takeoff(h)
